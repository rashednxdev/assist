...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/live/zoom', label: 'Zoom class', icon: Video, moduleCode: 'LIVE_STREAM' },
      { href: '/live/hosting', label: 'Host live', icon: Radio, moduleCode: 'LIVE_STREAM' },
      { href: '/live/zoom/hosting', label: 'Host Zoom', icon: Radio, moduleCode: 'LIVE_STREAM' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/live/zoom/admin', label: 'Zoom class', icon: Video, moduleCode: 'LIVE_STREAM', requireCreate: true },
