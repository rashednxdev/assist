...
liveStreamRouter.get('/:id/messages', requireAdmin, asyncHandler(listGuestMessagesHandler));
liveStreamRouter.patch('/:id/guest-messages', requireAdmin, asyncHandler(setGuestMessagesHandler));
